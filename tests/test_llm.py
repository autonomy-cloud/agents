...
# from openagents.agents import APIConnectionError, llm
# from openagents.agents.llm import ChatContext, ToolContext, TypeInfo, ai_callable
# from openagents.plugins import anthropic, aws, google, mistralai, openai
# from openagents.rtc import VideoBufferType, VideoFrame
...
#     stream = await _request_fnc_call(
#         input_llm, "Can you show 'Hello OpenAgents!' on the screen?", fnc_ctx
#     )
#     fns = stream.execute_functions()
#     await asyncio.gather(*[f.task for f in fns])
#     await stream.aclose()

#     assert called_msg == "Hello OpenAgents!", "send_message should be called"
