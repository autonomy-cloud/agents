...
class LivekitRoomSyncClient:
    ...
    def _build_token(self, identity: str, name: str | None, video_grants: dict, attributes: dict | None = None) -> str:
    ...
    def _build_participant_token(self, participant_uuid: str, name: str | None) -> str:
        ...
        return self._build_token(
            f"human-external-{participant_uuid}",
            name,
            {"canPublish": True, "canPublishData": True, "canSubscribe": False, "canUpdateOwnMetadata": False},
            {
                "cast.participant_type": "HUMAN",
                "cast.participant_source": "EXTERNAL_MEETING",
                "cast.external_participant_id": participant_uuid,
            },
        )
    ...
    def build_source_participant_configuration(self) -> RoomSyncSourceParticipantConfiguration | None:
        ...
        token_identity = f"cast-meeting-source-{uuid.uuid4().hex[:8]}"
