...
class TestKeyProviderOptions:
    ...
    def test_default_values(self) -> None:
        ...
        from openagents.rtc.e2ee import (
            KeyProviderOptions,
        ...
        from openagents.rtc._proto import e2ee_pb2 as proto_e2ee
    ...
    def test_custom_values(self) -> None:
        ...
        from openagents.rtc.e2ee import KeyProviderOptions
        from openagents.rtc._proto import e2ee_pb2 as proto_e2ee
...
class TestE2EEOptions:
    ...
    def test_default_values(self) -> None:
        ...
        from openagents.rtc.e2ee import E2EEOptions, KeyProviderOptions
        from openagents.rtc._proto import e2ee_pb2 as proto_e2ee
...
class TestPublicExports:
    ...
    def test_key_derivation_function_exported(self) -> None:
        ...
        from openagents.rtc import KeyDerivationFunction
    ...
    def test_encryption_type_exported(self) -> None:
        ...
        from openagents.rtc import EncryptionType
    ...
    def test_e2ee_classes_exported(self) -> None:
        ...
        from openagents.rtc import E2EEOptions, KeyProviderOptions
