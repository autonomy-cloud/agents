...
from openagents.agents import JobContext, JobProcess, ipc, job, utils
from openagents.agents.ipc.log_queue import LogQueueHandler, LogQueueListener
from openagents.agents.utils.aio import duplex_unix
from openagents.protocol import agent
...
async def _job_entrypoint_session_aclose_hangs(job_ctx: JobContext) -> None:
    ...
    from openagents.agents.ipc import job_proc_lazy_main
...
def test_inference_executor_is_alive_after_proc_closed() -> None:
    from openagents.agents.ipc.inference_proc_executor import InferenceProcExecutor
