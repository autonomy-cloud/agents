...
> = {
  ...
  amdPrediction: { background: "rgba(217, 70, 239, 0.16)", color: "#E879F9" },
  eotPrediction: { background: "rgba(20, 184, 166, 0.16)", color: "#2DD4BF" },
  functionToolsStarted: {
    background: "rgba(168, 85, 247, 0.16)",
    color: "#C084FC",
  },
  debugMessage: { background: "rgba(107, 114, 128, 0.16)", color: "#9CA3AF" },
};
