...
const defaultConfig: AppConfig = {
  title: "Coworker Console",
  description:
    "A workbench for testing and operating digital coworker agents.",
  video_fit: "contain",
  settings: {
    editable: true,
    theme_color: "cyan",
  ...
  const getSettingsFromUrl = useCallback(() => {
    ...
    return {
      ...
      outputs: {
        ...
        workstation: params.get("workstation") === "1",
        chat: params.get("chat") === "1",
      },
    } as UserSettings;
  }, [appConfig]);
  ...
  const setUrlSettings = useCallback(
    (us: UserSettings) => {
      const obj = new URLSearchParams({
        ...
        workstation: boolToString(us.outputs.workstation),
