...
class ImageContent(BaseModel):
    ...
    from openagents.agents.utils.images import encode, EncodeOptions, ResizeOptions
...
class MetricsReport(TypedDict, total=False):
    ...
    segmented by that TTS. Absent when no audio came from a OpenAgents TTS this turn: no TTS,
...
class ChatMessage(BaseModel):
    ...
    def text_content(self) -> str | None:
        """
        Returns a string of all text content in the message, with OpenAgents's
