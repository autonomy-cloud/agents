...
from openagents.agents import inference
from openagents.agents.llm import AgentHandoff, ChatContext, FunctionCall, FunctionCallOutput, utils
...
def skip_if_no_credentials():
    required_vars = ["OPENAGENTS_API_KEY", "OPENAGENTS_API_SECRET"]
...
def test_dict():
    ...
    from openagents.agents.beta import Instructions
    from openagents.agents.llm import ChatContext, ImageContent
...
def test_chat_ctx_can_be_serialized_and_deserialized_with_defaults():
    from openagents.agents.llm import AgentHandoff, ChatContext, ChatMessage
...
async def test_summarize():
    from openagents.agents import ChatContext
...
def test_instructions_serialization():
    ...
    from openagents.agents.llm.chat_context import Instructions
