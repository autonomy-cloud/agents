...
from openagents.agents.llm import ChatChunk, ChatContext, ChoiceDelta, CompletionUsage
from openagents.agents.llm.tool_context import ToolContext
from openagents.agents.utils import aio
from openagents.agents.voice.agent import ModelSettings
...
class TestTimeToFirstSentence:
    ...
    async def test_none_when_tts_published_no_stamp(self) -> None:
        # frames that never came from a OpenAgents TTS carry no started-time userdata (a
