...
from openagents.agents.llm.realtime import MessageGeneration
from openagents.agents.metrics.base import Metadata
...
class AgentActivity(RecognitionHooks):
    ...
    def _resolve_expressive_options(self) -> ExpressiveOptions | None:
        ...
        - the inference gateway TTS (``openagents.agents.inference.TTS``): the markup
    ...
    def _resolve_interruption_detection(self) -> inference.AdaptiveInterruptionDetector | None:
        # Adaptive interruption used OpenAgents's hosted inference service. The
        # absorbed runtime uses deterministic VAD interruption locally.
        return None
