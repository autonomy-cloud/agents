...
from openagents.agents.tokenize.blingfire import SentenceTokenizer
from openagents.agents.tokenize.token_stream import _XML_TAG_RE
from openagents.agents.tts.markup_utils import extract_and_strip
...
class TestXaiDialect:
    ...
    def test_llm_instructions_registered(self) -> None:
        from openagents.agents.tts import _provider_format as pf
...
class TestFishAudioDialect:
    ...
    def test_new_emotions_advertised_and_mapped(self) -> None:
        from openagents.agents.tts import _provider_format as pf
        from openagents.agents.tts._mood import match_mood
    ...
    def test_steering_is_sparse_over_default(self) -> None:
        from openagents.agents.voice.agent_session import (
...
class TestPlainTextAngleBrackets:
    ...
    def test_bare_lt_is_not_a_tag(self) -> None:
        from openagents.agents.tokenize.token_stream import _has_unclosed_xml_tags
...
class TestUniversalMarkupStrip:
    ...
    def test_split_all_markup_across_providers(self) -> None:
        from openagents.agents.tts._provider_format import split_all_markup
    ...
    def test_expression_attribute_shape(self) -> None:
        from openagents.agents.tts._provider_format import expression_attribute, split_all_markup
    ...
    def test_streaming_stripper_holds_partial_tags(self) -> None:
        from openagents.agents.tts._provider_format import TranscriptMarkupStripper
    ...
    def test_streaming_stripper_markdown_link_survives(self) -> None:
        ...
        rest = s.push("//docs.openagents.io) now.") + s.flush()
        assert first + rest == "Read [the docs](https://docs.openagents.io) now."
