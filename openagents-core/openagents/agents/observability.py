...
class Tagger:
    """Tag sessions with local metadata for observability.

    The Tagger allows adding string tags (key:value format) with optional
    structured metadata to sessions. The data remains in the local session
    report; OpenAgents does not upload it.
