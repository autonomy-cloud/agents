...
from openagents.agents import APIConnectionError, utils
from openagents.agents.llm import ChatContext, ChatMessage
from openagents.agents.metrics import STTMetrics
from openagents.agents.stt import (
    STT,
    MultiSpeakerAdapter,
    RecognizeStream,
    SpeechData,
...
from openagents.agents.stt.stt import RecognitionUsage
...
from openagents.agents.voice.keyterm_detection import KeytermDetector
...
def test_keyterms_reach_the_wrapped_stt() -> None:
    ...
    adapter._update_session_keyterms(["OpenAgents", "WebRTC"])
    assert wrapped.pushed_keyterms == [["OpenAgents", "WebRTC"]]
