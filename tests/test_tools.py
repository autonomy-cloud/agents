...
from openagents.agents.llm._strict import to_strict_json_schema
from openagents.agents.llm.utils import (
...
def test_end_call_tool_ignore_on_enter_flag():
    from openagents.agents.beta import EndCallTool
...
class TestToolExecution:
    ...
    def test_parse_function_arguments_strict(self):
        ...
        from openagents.agents.llm.utils import parse_function_arguments
    ...
    async def test_execute_function_call_preserves_valid_argument_structure(self):
        ...
        from openagents.agents.llm.llm import FunctionToolCall
        from openagents.agents.llm.utils import execute_function_call
...
class TestAsyncToolsetDedup:
    def test_same_id_no_conflict(self):
        ...
        from openagents.agents.llm.async_toolset import AsyncToolset
...
class TestAsyncToolOptions:
    ...
    def test_resolve_defaults_filled(self):
        from openagents.agents.voice.tool_executor import (
    ...
    def test_executor_uses_resolved_options(self):
        from openagents.agents.voice.tool_executor import _ToolExecutor
    ...
    def _mock_scope(session_update: str = "session", agent_update: str | None = None):
        ...
        from openagents.agents.voice.tool_executor import _resolve_async_tool_options
    ...
    def test_build_executor_map_routes_toolset_tools(self):
        from openagents.agents.llm.async_toolset import AsyncToolset
        from openagents.agents.voice.tool_executor import _build_executor_map, _ToolExecutor
    ...
    def test_build_executor_map_nested_async_toolset_wins(self):
        from openagents.agents.llm.async_toolset import AsyncToolset
        from openagents.agents.llm.tool_context import Toolset
        from openagents.agents.voice.tool_executor import _build_executor_map, _ToolExecutor
    ...
    def test_session_stores_resolved_options(self):
        ...
        from openagents.agents.voice.agent_session import AgentSession
    ...
    def test_agent_stores_raw_options(self):
        from openagents.agents.utils.misc import is_given
        from openagents.agents.voice.agent import Agent
...
def _make_run_context(
    ...
    from openagents.agents.llm import FunctionCall
    from openagents.agents.voice.events import RunContext
...
def _clear_running_tasks():
    ...
    from openagents.agents.voice.tool_executor import _RunningTasks
...
class TestAsyncToolOptionsRendering:
    ...
    def test_render_string(self):
        from openagents.agents.voice.tool_executor import _render
...
class TestHasCancellableTool:
    ...
    def test_plain_tools_not_cancellable(self):
        from openagents.agents.voice.tool_executor import has_cancellable_tool
...
def _key(
    ...
    """
    from openagents.agents.voice.tool_executor import _duplicate_key
...
def _register_fake(
    ...
    *,
    ...
    from openagents.agents.voice.tool_executor import _RunningTask
...
class TestCheckDuplicate:
    ...
    async def test_replace_raises_when_non_cancellable(self):
        ...
        from openagents.agents.llm.tool_context import ToolError
        from openagents.agents.voice.tool_executor import _ToolExecutor
...
class TestDuplicateScopeThroughExecute:
    ...
    async def test_confirm_param_excluded_from_key(self, _clear_running_tasks):
        ...
        from openagents.agents.llm.tool_context import CONFIRM_DUPLICATE_PARAM
        from openagents.agents.voice.tool_executor import _ToolExecutor
...
class TestCancelAll:
    ...
    async def test_cancel_task_companion_misses_non_cancellable(self):
        ...
        from openagents.agents.llm.tool_context import ToolError
        from openagents.agents.voice.tool_executor import _RunningTasks, _ToolExecutor, cancel_task
...
def _emitted_items(session: Any) -> list[Any]:
    ...
    from openagents.agents.voice.events import ToolExecutionUpdatedEvent
...
def _make_fake_speech():
    ...
    from openagents.agents.voice import SpeechHandle
...
def _make_reply_session(speech: Any) -> Any:
    ...
    from openagents.agents.llm import ChatContext
...
class TestToolCallEvents:
    ...
    async def test_sync_tool_started_then_done(self):
        from openagents.agents.voice.events import ToolCallEnded, ToolCallStarted
        from openagents.agents.voice.tool_executor import _ToolExecutor
    ...
    async def test_cancelled_tool(self):
        ...
        from openagents.agents.voice.events import ToolCallEnded
        from openagents.agents.voice.tool_executor import _ToolExecutor
    ...
    async def test_updates_and_deferred_result_with_reply_lifecycle(self):
        from openagents.agents.voice.events import (
            RunContext,
            ToolCallEnded,
            ToolCallStarted,
            ToolCallUpdated,
    ...
    async def test_interrupted_and_skipped_reply_outcomes(self):
        from openagents.agents.voice.events import RunContext, ToolReplyUpdated
        from openagents.agents.voice.tool_executor import _ToolExecutor
    ...
    async def test_error_after_update_is_deferred_with_final_id(self):
        from openagents.agents.voice.events import RunContext, ToolCallEnded
        from openagents.agents.voice.tool_executor import _ToolExecutor
