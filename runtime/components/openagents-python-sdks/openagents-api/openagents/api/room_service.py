...
from openagents.protocol.models import Room, ParticipantInfo
...
class RoomService(Service):
    ...
    Recommended way to use this service is via `openagents.api.OpenAgentsAPI`:

    ```python
    from openagents import api
    lkapi = api.OpenAgentsAPI()
    room_service = lkapi.room
    ```

    Also see https://docs.openagents.io/home/server/managing-rooms/ and https://docs.openagents.io/home/server/managing-participants/
    """
    ...
    async def update_room_metadata(self, update: UpdateRoomMetadataRequest) -> Room:
        """Updates a room's [metadata](https://docs.openagents.io/home/client/data/room-metadata/).
