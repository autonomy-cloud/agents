...
def _discover_factory_patches() -> dict[type, dict[str, Callable[[], Any]]]:
    ...
    stays cheap and free of OpenAgents import-order constraints.
    """
    from pydantic import BaseModel

    from openagents.agents.inference import interruption
    from openagents.agents.llm import chat_context
    from openagents.agents.voice import events
