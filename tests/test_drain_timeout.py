...
from openagents.agents.cli.cli import _ExitCli, _run_worker
from openagents.agents.cli.proto import CliArgs
from openagents.agents.ipc.supervised_proc import SupervisedProc, SupervisedProcKind
...
class TestDrainTimeout:
    ...
    def test_memory_monitor_does_not_swallow_exitcli(self) -> None:
        ...
        with (
            patch(
                "openagents.agents.ipc.supervised_proc.psutil.Process",
                side_effect=_ExitCli(),
            ),
            patch("openagents.agents.ipc.supervised_proc.asyncio.sleep", side_effect=_fake_sleep),
            patch("openagents.agents.ipc.supervised_proc.logger.exception") as mock_exception,
        ):
