...
from openagents.agents import Agent, AgentSession, AgentTask, RunContext, function_tool
...
async def test_guard_released_when_the_floor_never_arrives(
    ...
    from openagents.agents.voice.agent_activity import ActivityClosedError
